  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-gray-50 via-white to-gray-50 dark:from-gray-800 dark:via-gray-750 dark:to-gray-800">
          ...
          <div className="flex items-start space-x-4 mb-6">
            ...
            <div className="flex-1 min-w-0 pt-1">
              <motion.h3
                ...
                className="text-xl font-bold text-gray-900 dark:text-white truncate mb-1"
              >
                {name || email}
              </motion.h3>
              {email && name && (
              ...
              <motion.div
                ...
                className="mt-3 flex items-center gap-4 text-xs text-gray-400 dark:text-gray-500"
              >
